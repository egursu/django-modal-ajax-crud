...
def get_object_verbose_name(object):
    if hasattr(object, 'model'):
        object = object.model
    return object._meta.verbose_name if object else ''
...
def get_object_verbose_name_plural(object):
    if hasattr(object, 'model'):
        object = object.model
    return object._meta.verbose_name_plural if object else ''
...
def get_field_verbose_name(object, field):
    if hasattr(object, 'model'):
        object = object.model
    return object._meta.get_field(field).verbose_name if object else ''
